...
$query = "SELECT email, password FROM login WHERE email ='" . $_SESSION['email'] . "'";
...
if ($new_pass != $new_pass1) {
    ...
    if ($old_pass1 == $orig_pass) {
        $query = "UPDATE  login SET password = '" . $new_pass . "' WHERE email = '" . $_SESSION['email'] . "'";
